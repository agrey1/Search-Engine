...
The project includes a website crawling bot which visits a page, collects the links from that page and saves the list of words found on that page. We can then perform a full-text search of this information to produce a fairly effective internet serach engine. As the project aims to demonstrate the capabilities of DSE, extensive use of Cassandra and Solr has been made.

An example of the project running with approximately 3GB of text from over 63,000 web pages can be found at http://51.254.181.89:8080/
